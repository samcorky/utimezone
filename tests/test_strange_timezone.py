...
def test_strange_timezone_transitions(tz_strange: TimeZone):
    ...
    """
    # Quick transition checks for 2026 (non-leap): DST starts around Feb 22 and ends around Oct 28.
    ...
    # End rule is unusual (day-of-year plus >24h). We perform simple checks for dates before/after the expected transition.
